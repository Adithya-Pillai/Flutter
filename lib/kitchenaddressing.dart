...
class AddAddressPageKitchen extends StatefulWidget {
  final String id;

  AddAddressPageKitchen({required this.id}); // Constructor accepts kitchenId

  @override
  _AddAddressPageState createState() => _AddAddressPageState();
}

class _AddAddressPageState extends State<AddAddressPageKitchen> {
  ...
  Future<void> _saveAddress() async {
    ...
    // Get a reference to the Firestore document for the kitchen
    DocumentReference kitchenDoc =
        FirebaseFirestore.instance.collection('kitchens').doc(widget.id);

    // Update the document with the new address
    await kitchenDoc.update({
      'address': newAddress,
    }).then((value) {
